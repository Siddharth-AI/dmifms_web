...
import { Shield, Utensils, Headset, ShieldCheck, Footprints, Hotel, ChefHat, Coffee, Sandwich, Users, Wallet, Mail, Briefcase, ArrowRight, Layers, ArrowUpRight, CheckCircle2 } from "lucide-react";
...
const iconMap: Record<string, React.ElementType> = {
  shield: Shield, utensils: Utensils, headset: Headset,
  "shield-check": ShieldCheck, footprints: Footprints, cctv: Shield,
  hotel: Hotel, "chef-hat": ChefHat, coffee: Coffee, sandwich: Sandwich,
  users: Users, wallet: Wallet, mail: Mail, briefcase: Briefcase,
};
...
export default function AdditionalServicesPage() {
  ...
  return (
    <>
      ...
      <section id="services" className="py-24 bg-slate-50 relative -mt-20 rounded-t-[3rem] shadow-[0_-20px_50px_rgba(0,0,0,0.1)]">
        <div className="container-max px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20 pt-8">
            <ScrollReveal>
              <h2 className="text-3xl md:text-5xl font-extrabold text-brand-text mb-6">
                Tailored Solutions for <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-navy to-brand-blue">Every Need</span>
              </h2>
              <p className="text-lg text-slate-500">
                From specialized security to warm hospitality, we provide end-to-end services to elevate your facility&apos;s operations.
              </p>
            </ScrollReveal>
          </div>
          ...
          <div className="space-y-16 lg:space-y-24">
            {data.categories.map((cat, ci) => {
              ...
              return (
                <div key={cat.id} className={`flex flex-col ${isEven ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-12 lg:gap-20 items-center`}>
                      ...
                      <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                          ...
                          <p className="text-slate-500 font-medium">
                            Professional {cat.title.toLowerCase()} services designed to seamlessly integrate with your core operations.
                          </p>
                        </div>
                      </div>
                    </ScrollReveal>
                  ...
                  <div className="w-full lg:w-2/3">
                    <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
                      {cat.services.map((service, si) => {
                        ...
                        return (
                          <ScrollReveal key={service.id} direction="up" delay={si * 0.1}>
                            <div className="group flex items-start gap-4 p-5 md:p-6 rounded-2xl bg-white border border-slate-100 hover:border-slate-300 hover:shadow-lg transition-all duration-300 cursor-default">
                              ...
                              <div className="flex-1 pt-1">
                                ...
                                <p className="text-sm text-slate-400 mt-1 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -translate-x-2 group-hover:translate-x-0">
