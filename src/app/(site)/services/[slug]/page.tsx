      ...
      <section className="relative pt-28 pb-24 overflow-hidden bg-[#0A192F]">
        ...
        <div className="absolute inset-0 z-0">
          {service.image ? (
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#0A192F] to-[#1A365D]" />
          )}
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  {service.features.map((feature, idx) => (
                    <div
                      ...
                      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#EAB308] to-[#F59E0B] opacity-0 group-hover:opacity-100 transition-opacity rounded-t-[1.5rem]" />
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-24 space-y-8">
                ...
                <div className="bg-[#0A192F] p-8 relative overflow-hidden shadow-2xl border border-[#1A365D]">
                  <div className="absolute -top-10 -right-10 w-40 h-40 bg-[#EAB308]/20 rounded-full blur-[40px]" />
