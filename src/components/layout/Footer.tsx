...
import { MapPin, Mail, Phone, ArrowRight, Award, ShieldCheck, BadgeCheck } from "lucide-react";
      ...
      <div className="container-max section-padding relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 pb-16 border-b border-white/10">
          <div className="max-w-md">
            <Link href="/" className="flex items-center gap-3 mb-6 group">
              <div className="w-12 h-12 rounded-xl bg-[#111] border border-white/10 flex items-center justify-center shadow-lg group-hover:border-[#FFD700] group-hover:bg-[#FFD700]/10 transition-colors">
                <span className="text-white font-black text-lg group-hover:text-[#FFD700] transition-colors">DM</span>
              </div>
              <div>
                <div className="font-bold text-white text-xl tracking-tight">DM23 IFMS</div>
                <div className="text-[11px] text-slate-400 font-medium tracking-widest uppercase">Facility Management</div>
              </div>
            </Link>
            <p className="text-slate-400 text-[15px] leading-relaxed mb-8">
              Elevating facility standards across India with premium, integrated, and technology-driven management solutions.
            </p>
          ...
          <div className="w-full lg:w-auto p-8 rounded-[2rem] bg-white/5 border border-white/10 relative overflow-hidden group">
            ...
            <p className="text-sm text-slate-400 mb-6 relative z-10">Get the latest insights on facility management.</p>
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            <h4 className="font-bold text-white text-sm mb-6 uppercase tracking-wider flex items-center gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-[#FFD700]" /> Standards
            </h4>
            <div className="flex flex-col gap-4">
              {certBadges.map(({ icon: Icon, label }) => (
                <div key={label} className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/5 hover:border-white/20 transition-colors w-max pr-6">
          ...
          <div>
            <h4 className="font-bold text-white text-sm mb-6 uppercase tracking-wider flex items-center gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-[#FFD700]" /> Get in Touch
            </h4>
            <div className="space-y-5">
              <div className="flex items-start gap-3 group">
                ...
                <span className="text-[14px] text-slate-400 leading-relaxed pt-1">
                  Lakshmi Nivas, Vinayaka Nagar, <br/>Murugeshpalya, Bangalore — 560017
                </span>
              </div>
              <div className="flex items-center gap-3 group">
                ...
                <a href="mailto:info@dm23ifms.com" className="text-[14px] text-slate-400 hover:text-white transition-colors">
                  info@dm23ifms.com
                </a>
              </div>
              <div className="flex items-center gap-3 group">
                ...
                <a href="tel:+910000000000" className="text-[14px] text-slate-400 hover:text-white transition-colors font-medium">
                  +91 00000 00000
                </a>
              </div>
            </div>
